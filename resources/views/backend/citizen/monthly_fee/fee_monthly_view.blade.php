...
<div class="content-wrapper">
			...
			<div class="col-12">
                    ...
                    <div class="box bb-3 border-warning">
                        <div class="box-header">
                          <h4 class="box-title"> <strong> Tarifa mensual </strong></h4>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-4" style="padding-top: 25px;">
                                            <a href="{{route('monthly.fee.view')}}" class="btn btn-info" name="search"> Nueva consulta </a>
                                        </div>
  ...
  <script type="text/javascript">
    $(document).on('click','#search',function(){
      ...
      var month = $('#month').val(); // Recuperamos el mes indicado en el campo
       $.ajax({
        url: "{{ route('citizen.monthly.fee.classwise.get')}}", // Llamamos a la ruta para obtener las tarifas
        type: "get",
        data: {'year_id':year_id,'class_id':class_id,'month':month}, // Pásamos los datos extraidos anterioremes
        beforeSend: function() {
        },
