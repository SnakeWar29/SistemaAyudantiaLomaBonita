...
<body>
    ...
    @php
        $registrationfee = App\Models\FeeCategoryAmount::where('fee_category_id','2')->where('class_id',$details->class_id)->first(); // Apuntamos a la categoria 1, porque es la de registro
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="desc"> <center> <strong> Tarifa mensual </strong> </center> </td>
