...
<div class="content-wrapper">
 ...
 <div class="box">
   <div class="box-header with-border">
	 <h4 class="box-title"> Promoción de un ciudadano </h4>
   </div>
   <div class="box-body">
	 <div class="row">
	   <div class="col">
		...
		<form method="POST" action="{{route('promotion.citizen.registration',$editData->citizen_id)}}" enctype="multipart/form-data">
		   @csrf
           <input type="hidden" name="id" value="{{$editData->id}}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                    <input type="date" name="dob" class="form-control" required="" value="{{$editData['citizen']['dob']}}">
                                    </div>
                                </div>
             ...
             <div class="text-xs-right">
                <input type="submit" class="btn btn-rounded btn-info mb-5" value="Confirmar promoción">
             </div>
