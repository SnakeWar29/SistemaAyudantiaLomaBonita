                    ...
                    <div class="col-12">
                        <!-- Campo para el nombre de la clase del ciudadno -->
                            <div class="form-group">
                               ...
                               <div class="controls">
                                   <input type="text" name="name" onpaste="return false;" class="form-control"  minlength="4" maxlength="4" required="" onkeypress="return (event.charCode >= 48 && event.charCode <= 57)" maxlength="4"> </div>
                                    <!-- Se llama a traer el error que marcara cualqier tipo de error usando message -->
                                    @error('name')
                                        <span class="text-danger"> {{$message="Hubo un error al realizar la operación, puede deberse a que el año ya está registrado"}}</span>
                                    @enderror
