...
<div class="content-wrapper">
 ...
 <div class="box">
   <div class="box-header with-border">
	 <h4 class="box-title">Editar categoria de tarifa </h4>
   </div>
   <div class="box-body">
	 <div class="row">
	   <div class="col">
		...
		<form method="POST" action="{{route('update.fee.category',$editData->id)}}"> <!-- Apuntamos el form a la ruta de edicion con el id unico del año -->
		   @csrf
				<!-- -->
                <div class="row">
                    <div class="col-12">
                            <div class="form-group">
                               <h5> Categoría de tarifa <span class="text-danger">*</span></h5>
                               <div class="controls">
