                                ...
                                <div class="col-md-2">
                                    <!-- Campo para el monto de la tarifa-->
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                            <input type="text" name="full_support[]" value="{{$edit->full_support}}" class="form-control" required=""> </div>
                                        </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <!-- Campo para el monto de la tarifa-->
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                            <input type="text" name="monthly_support[]" value="{{$edit->monthly_support}}" class="form-control" required=""> </div>
                                        </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <!-- Campo para el monto de la tarifa-->
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                            <input type="text" name="total_payments[]" value="{{$edit->total_payments}}" class="form-control" required=""> </div>
                                        </div>
                                </div>
