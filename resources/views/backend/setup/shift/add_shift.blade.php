...
<div class="content-wrapper">
 ...
 <div class="box">
   <div class="box-header with-border">
	 <h4 class="box-title"> Añadir nuevo turno de ciudadano </h4>
   </div>
   <div class="box-body">
	 <div class="row">
	   <div class="col">
		...
		<form method="POST" action="{{route('store.citizen.shift')}}">
		   @csrf
				<!-- -->
                <div class="row">
                    <div class="col-12">
                            ...
                            <div class="form-group">
                               ...
                               <div class="controls">
                                   <input type="text" name="name" minlength="5" onpaste="return false;" class="form-control" required=""> </div>
                                    ...
                                    @error('name')
                                        <span class="text-danger"> {{$message="Hubo un error al realizar la operación, puede deberse a que el turno ya está registrado"}}</span>
                                    @enderror
             ...
             <div class="text-xs-right">
                <input type="submit" class="btn btn-rounded btn-info mb-5" value="Añadir turno">
             </div>
