...
<div class="content-wrapper">
 ...
 <div class="box">
   <div class="box-header with-border">
	 <h4 class="box-title">Editar apoyo </h4>
   </div>
   <div class="box-body">
	 <div class="row">
	   <div class="col">
		...
		<form method="POST" action="{{route('update.support.type',$editData->id)}}"> <!-- Apuntamos el form a la ruta de edicion con el id unico del año -->
		   @csrf
				<!-- -->
                <div class="row">
                    <div class="col-12">
                            <div class="form-group">
                               ...
                               <div class="controls">
                                   <input type="text" name="name" minlength="10" class="form-control" required="" value="{{$editData->name}}"> </div>
                                    ...
                                    @error('name')
                                        <span class="text-danger"> {{$message="Hubo un error al realizar la operación, puede ser porque el apoyo ya está registrado"}}</span>
                                    @enderror
