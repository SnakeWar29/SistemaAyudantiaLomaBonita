			...
			<div class="col-12">
                    ...
                    <div class="box bb-3 border-warning">
                        <div class="box-header">
                          <h4 class="box-title"> <strong> Entregar apoyo </strong></h4>
                        </div>
                        <!-- Inicia el form para poder filtrar ciudadanos -->

                        <div class="box-body">
                            <form method="post" action="{{route('supports.entry.store')}}">
                            @csrf
                                <div class="row">
                                    <div class="col-md-3">
                                ...
                                <div class="row d-none" id="supports-entry"> <!-- La clase row d-none sirve para ocultar la tabla-->
                                    <div class="col-md-12">
                                        <table class="table table-bordered table-striped" style="width: 100%">
                                            ...
                                            <input type="submit" class="btn btn-rounded btn-primary"  value="Enviar">
                                    </div>
...
<script type="text/javascript">
    $(document).on('click','#search',function(){
      ...
      var assign_support_id = $('#assign_support_id').val(); // Recuperamos el apoyo obtenido del campo
       $.ajax({
        url: "{{ route('citizen.support.getcitizens')}}", // Se redigirge a la ruta para buscar los datos del ciudadano
        type: "GET",
        ...
        success: function (data) { // Retornamos la funcion con los datps pbtenidos de la ruta
          $('#supports-entry').removeClass('d-none'); // Re remueve la clase d-none que hace que la tabla sea invisible
          var html = '';
          $.each( data, function(key, v){
            ...
            '<td><input type="text" class="form-control form-control-sm" minlength="2" maxlength="5" onpaste="return false;" onkeypress="return (event.charCode >= 46 && event.charCode <= 57)" name="marks[]"></td>'+
            '</tr>';
          });
