...
<aside class="main-sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview {{($prefix == '/citizens')?'active':'' }}">
            ...
            <ul class="treeview-menu">
              <li class="{{($route == '----')?'active':'' }}"><a href="{{route('citizen.registration.view')}}"><i class="ti-more"></i> Ciudadanos </a></li>
              <li class="{{($route == '----')?'active':'' }}"><a href="{{route('rol.generate.view')}}"><i class="ti-more"></i> Generar rol </a></li>
              <li class="{{($route == '----')?'active':'' }}"><a href="{{route('registration.fee.view')}}"><i class="ti-more"></i> Tarifa de registro </a></li>
              <li class="{{($route == '----')?'active':'' }}"><a href="{{route('monthly.fee.view')}}"><i class="ti-more"></i> Tarifa mensual </a></li>
            </ul>
        </li>
